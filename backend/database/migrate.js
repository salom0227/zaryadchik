...
INSERT INTO admin_sessions (admin_username, password_hash)
VALUES ('admin', '$2b$10$YourHashedPasswordHere')
ON CONFLICT (admin_username) DO NOTHING;

COMMENT ON TABLE users IS 'User accounts for the ZaryadUz application';
COMMENT ON TABLE stations IS 'EV charging, powerbank, and scooter stations';
COMMENT ON TABLE bookings IS 'User bookings for stations';
COMMENT ON TABLE admin_sessions IS 'Admin user credentials';
